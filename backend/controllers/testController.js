...
// // ═══════════════════════════════════════════════
// // GET /api/tests
// // Returns all global tests + this vendor's price
// // Both admin and vendor can call this
// // ═══════════════════════════════════════════════
...
// // ═══════════════════════════════════════════════
// // POST /api/tests
// // Add a new test to global library
// // Both admin and vendor can add
// // ═══════════════════════════════════════════════
...
// // ═══════════════════════════════════════════════
// // PUT /api/tests/:id/price
// // Vendor sets/updates their price for a test
...
//       if (existingPrice) {
//         // Update existing test price inside array
...
//         );
//       } else {
//         // Push new test price into existing vendor doc
//         await VendorTestPrice.findOneAndUpdate(
//           { vendorId },
...
//       }
//     } else {
//       // Create brand new vendor doc with first price entry
...
// // ═══════════════════════════════════════════════
// // PATCH /api/tests/:id/toggle-vendor
// // Vendor toggles a test on/off for themselves
// // ═══════════════════════════════════════════════
...
// // ═══════════════════════════════════════════════
// // PUT /api/tests/:id  — edit full test (creator or admin)
// // ═══════════════════════════════════════════════
...
// // Remove a test from global library
// // ═══════════════════════════════════════════════
// exports.deleteTest = async (req, res) => {
//   try {
//     if (req.user.role !== "admin")
//       return res.status(403).json({ message: "Only admin can delete global tests." });

//     await Test.findByIdAndDelete(req.params.id);

//     // Pull this test entry from every vendor's prices array
...
// DELETE /api/tests/:id
// Remove a test from global library.
// Allowed for: the vendor who created the test, OR an admin.
// A vendor cannot delete another vendor's test or an admin-added test —
// mirrors the same isAdmin || isCreator check used in updateTest above.
// ═══════════════════════════════════════════════
exports.deleteTest = async (req, res) => {
  try {
    const test = await Test.findById(req.params.id);
